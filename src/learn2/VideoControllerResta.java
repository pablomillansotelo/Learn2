 ...
 * @author EdwinRivas
 */
public class VideoControllerResta implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Media media = new Media(VideoControllerMulti.class.getResource("videos/videoResta.mp4").toExternalForm());
...
//
        ...
        practice.setOnAction(e ->{
            try {
                ...
                Logger.getLogger(VideoControllerResta.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
